 # Shiny Web App for Reactive Underwriting tool built for Pacific Cross Vietnam by Minh Ho - updated August 25, 2021
...
ui <- fluidPage(
  ...
  actionButton("go", "See result", icon("paper-plane"), 
  ...
  mainPanel(
    tabsetPanel(
      ...
      tabPanel("Information", 
        ...
        tags$i("This application might not work properly sometimes because of the problem with the source data which I sync in real time with WHO. For example, in July 24th, 2021, I found a problem in WHO data (they accidentally put an extra comma in the source file), which makes the server read the file in a wrong way, the probability of COVID 19 infection becomes abnormally high. I will try to maintain this application, if you find any abnormality, please report to me at hothieuminh@gmail.com")
